...
\begin{frame}%
  \frametitle{\hspace{7mm}JIRA Issue Estimations}%
  \framesubtitle{\hspace{7mm}All assignments must use the same story point values.}
  %
  \begin{mdframed}[style=HavasuLightBlueStyle]%
    \textbf{Rule \#2}\\%
...
\begin{frame}%
  \frametitle{\hspace{7mm}Daily Responsibilities}%
  \framesubtitle{\hspace{7mm}All assignments must use the same story point values.}%
